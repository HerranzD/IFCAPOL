...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan  30 07:12:00 2023
...
coadded_dir = survey.data_dir+'postPTEP/coadd_signal_maps/'
noise_dir   = survey.data_dir+'postPTEP/noise/'
radiops_dir = survey.data_dir+'postPTEP/foregrounds/radio_sources/'
total_dir   = survey.data_dir+'postPTEP/total_maps/'
...
def coadd_name(sim_number,chan_name):
    """
    Returns the name of the post-PTEP coadded (CMB+foregrounds) simulation file for
    a given LiteBIRD channel and a given simulation number (between 0 and 49).
...
def detected_catalogue_name(sim_number,chan_name):
    ...
    fname = output_catdir+'IFCAPOL_catalogue_postPTEP_'+chan_name+'_'+simstr+'.fits'
    return fname
...
def post_PTEP_simulated_maps(sim_number,chan_name):
    """
    ...
    ----------
    sim_number : int
        The simulation number. It must take a value between 0 and 49.
    chan_name : str
        The name of the LiteBIRD channel
